...
function AddToPipelineModal({
  ...
  return (
    <Modal open onClose={onClose} title="Ajouter au pipeline" size="lg" dismissible={!creating}>
      <>
        {/* Tabs */}
        <div className="flex p-1 mb-4 rounded-lg" style={{ background: 'var(--bg3)', border: '1px solid var(--border)' }}>
          <button
