    ...
    <aside className="fixed left-0 top-0 h-screen w-56 bg-[#161b27] border-r border-[rgba(255,255,255,0.07)] flex flex-col z-40">
      ...
      <div className="px-5 py-6 border-b border-[rgba(255,255,255,0.07)]">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-[#e8edf5] text-sm font-semibold leading-none">Dashboard</p>
            <p className="text-[#5a6a82] text-xs leading-none mt-0.5">Admin</p>
          </div>
        </div>
      </div>
      ...
      <nav className="flex-1 px-3 py-4 overflow-y-auto">
        <p className="text-[#5a6a82] text-xs font-medium uppercase tracking-wider px-2 mb-3">Navigation</p>
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 ${
                  activePage === item.id
                    ...
                    : 'text-[#a0aec0] hover:text-[#e8edf5] hover:bg-[rgba(255,255,255,0.05)]'
                }`}
              >
